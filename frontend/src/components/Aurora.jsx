...
export default function Aurora({
  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div ref={ctnDom} className="absolute inset-0 pointer-events-none" />

      {/* Text overlay */}
      <div className="relative z-20 py-3 flex justify-center items-center h-full">
        <BlurText
          text="Compliance Assistant"
          delay={150}
          animateBy="words"
